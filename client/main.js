...
socket.on("message", (data) => {
  ...
  console.log("I received :" + data.text);
  //Convert received Hex message to Bytes
...
//On received socket of "welcoming"
...
//On received  socket of "KeySend"
socket.on("keySend", (data) => {
  //Store the new key into local variable.
  key_128 = data;
  console.log("received new key " + data);
});
...
//This function is used to display any password reci to user
